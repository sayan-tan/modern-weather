...
function ChartTooltipContent(props: React.ComponentProps<typeof RechartsPrimitive.Tooltip> &
  ...
  const payload = 'payload' in props && Array.isArray((props as any).payload) ? (props as any).payload : undefined;
  const label = 'label' in props ? (props as any).label : undefined;
